...
export const DURATION_OPTIONS = [
  { value: '30', unit: 'seconds', label: '30 segundos' },
  { value: '45', unit: 'seconds', label: '45 segundos' },
  { value: '60', unit: 'seconds', label: '1 minuto' },
  { value: '90', unit: 'seconds', label: '1:30 minutos' },
  { value: '2', unit: 'minutes', label: '2 minutos' },
  { value: '3', unit: 'minutes', label: '3 minutos' },
  { value: '5', unit: 'minutes', label: '5 minutos' },
  { value: '10', unit: 'minutes', label: '10 minutos' },
];
