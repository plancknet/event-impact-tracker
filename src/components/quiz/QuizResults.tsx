    ...
    >
      {isLoading ? (
        ...
        <span className="flex items-center justify-center gap-2 whitespace-normal text-center leading-snug">
          {t("Ativar meu aplicativo personalizado por apenas R$ 47")}
      ...
      <header className="sticky top-0 z-50 border-b border-quiz-border/60 bg-quiz-card/90 backdrop-blur">
        <div className="container max-w-6xl mx-auto px-4 py-4 flex items-center justify-between gap-4">
          ...
          <div className="text-sm font-bold text-red-600">
            {t("Oferta valida por")} {minutes}:{seconds} {t("minutos")}
          </div>
        </div>
      </header>
      ...
      <div className="w-full max-w-lg mx-auto flex flex-col space-y-6">
        ...
        <div className="text-center space-y-2 animate-stagger-fade">
          ...
          <h1 className="text-2xl sm:text-3xl font-semibold text-quiz-foreground">
            {t("ThinkAndTalk personalizado para seu perfil")}
          </h1>
        </div>
        ...
        >
          <p className="text-quiz-foreground leading-relaxed">
            {t("Criamos um aplicativo com um plano sob medida para você criar vídeos com mais clareza, confiança e consistência usando roteiros inteligentes e teleprompter com IA.")}
          </p>
        ...
        <div className="rounded-2xl border-2 border-quiz-purple/30 bg-gradient-to-br from-quiz-purple/10 to-quiz-blue/10 p-5 text-center space-y-2 animate-scale-up-card" style={{ animationDelay: "120ms" }}>
          <p className="text-lg font-bold text-quiz-purple">{t("♾️ Acesso vitalício")}</p>
          <p className="text-sm text-quiz-foreground leading-relaxed">
            {t("Você faz um pagamento único de")} <span className="font-semibold">R$47</span> {t("e tem acesso ao aplicativo com a IA personalizada para sempre!")}
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-green-200 bg-gradient-to-br from-green-50 via-emerald-50 to-green-100 p-4 text-center text-sm text-green-900 shadow-sm">
          <span className="inline-flex items-center justify-center gap-2 font-semibold">
            ...
            {t("Tenha acesso a um grupo exclusivo no WhatsApp para networking com outros criadores de conteúdo e alavancagem para viralização de conteúdo.")}
          </span>
        </div>
        ...
        <div className="space-y-4 animate-stagger-fade" style={{ animationDelay: "150ms" }}>
          <div className="rounded-2xl border border-quiz-border/60 bg-quiz-card/90 p-5 space-y-5">
            <div className="space-y-3">
              <p className="text-base font-semibold text-quiz-foreground">{t("😓 Antes do ThinkAndTalk")}</p>
              <div className="space-y-2 text-sm text-quiz-foreground">
                <p>{t("❌ Passava horas olhando para a tela sem saber o que falar no vídeo")}</p>
                <p>{t("❌ Gravava vários takes e ainda assim não ficava satisfeito")}</p>
                <p>{t("❌ Perdida(o) sobre o que postar e quando postar")}</p>
                <p>{t("❌ Vídeos longos, confusos ou sem uma mensagem clara")}</p>
                <p>{t("❌ Dependia de inspiração (que quase nunca vinha)")}</p>
                <p>{t("❌ Falava travado(a), esquecia partes importantes ou se perdia no meio do vídeo")}</p>
                <p>{t("❌ Falta de consistência: alguns dias postava, depois sumia")}</p>
                <p>{t("❌ Sentia insegurança e vergonha ao gravar")}</p>
                <p>{t("❌ Conteúdo não convertia em seguidores, leads ou vendas")}</p>
              </div>
            </div>
            <div className="border-t border-quiz-border/40" />
            <div className="space-y-3">
              <p className="text-base font-semibold text-quiz-foreground">{t("🚀 Depois do ThinkAndTalk")}</p>
              <div className="space-y-2 text-sm text-quiz-foreground">
                <p>{t("✅ Roteiros prontos em segundos, alinhados ao objetivo do vídeo")}</p>
                <p>{t("✅ Gravação fluida com teleprompter ajustável")}</p>
                <p>{t("✅ Clareza total sobre o que dizer, como dizer e em quanto tempo")}</p>
                <p>{t("✅ Conteúdos objetivos, envolventes e fáceis de entender")}</p>
                <p>{t("✅ Consistência real: postar virou rotina, não sofrimento")}</p>
                <p>{t("✅ Confiança ao falar, mesmo para quem é tímido ou iniciante")}</p>
                <p>{t("✅ Vídeos adaptados para Instagram, TikTok, YouTube, Reels, Shorts e Lives")}</p>
                <p>{t("✅ Mais engajamento, retenção e conexão com o público")}</p>
                <p>{t("✅ Mais autoridade, profissionalismo e resultados")}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="rounded-2xl border border-quiz-border/60 bg-quiz-card/90 p-5 space-y-4">
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-quiz-muted">{t("· 98% satisfação")}</span>
              </div>
            </div>
            <div className="space-y-3 text-sm text-quiz-foreground">
              <p className="italic">{t("\"Ficou incrível o resultado.\"")} — <span className="font-semibold">Maria S.</span></p>
              <p className="italic">{t("\"Em menos de 5 minutos ficou pronto. Revolucionário!\"")} — <span className="font-semibold">Alberto D.</span></p>
              <p className="italic">{t("\"Só com o celular eu consegui.\"")} — <span className="font-semibold">Ana B.</span></p>
              <p className="italic">{t("\"Economizei tempo e muita grana. Sensacional!\"")} — <span className="font-semibold">Carlo R.</span></p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4 animate-stagger-fade" style={{ animationDelay: "260ms" }}>
          <div className="rounded-2xl border border-quiz-border/60 bg-quiz-card/90 p-5 space-y-4">
            <p className="text-quiz-foreground font-semibold text-base">
              {t("A mesma técnica que os grandes criadores usam para gravar vídeos profissionais — agora no seu celular.")}
            </p>
            <div className="space-y-3 text-sm text-quiz-foreground">
              <p>✅ <span className="font-semibold">{t("Técnica dos grandes criadores")}</span> — {t("usada pelos maiores influenciadores")}</p>
              <p>📱 <span className="font-semibold">{t("Só precisa do celular")}</span> — {t("zero custo com edição")}</p>
              <p>⚡ <span className="font-semibold">{t("Resultado em 5 minutos")}</span> — {t("rapidez impressionante")}</p>
              <p>🎯 <span className="font-semibold">{t("Sem conhecimento técnico")}</span> — {t("qualquer pessoa consegue")}</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4 animate-stagger-fade" style={{ animationDelay: "340ms" }}>
          <p className="text-lg font-semibold text-quiz-foreground text-center">{t("Como funciona?")}</p>
          <div className="rounded-2xl border border-quiz-border/60 bg-quiz-card/90 p-5 space-y-4">
            <div className="space-y-3 text-sm text-quiz-foreground">
              <p><span className="font-semibold text-quiz-purple">1.</span> {t("Abra no celular")}</p>
              <p><span className="font-semibold text-quiz-purple">2.</span> {t("Informe o tema do vídeo")}</p>
              <p><span className="font-semibold text-quiz-purple">3.</span> {t("Selecione as notícias recentes")}</p>
              <p><span className="font-semibold text-quiz-purple">4.</span> {t("A IA cria o roteiro")}</p>
            </div>
            <p className="text-quiz-foreground font-semibold text-center pt-2">
              {t("✨ Pronto — roteiro no teleprompter profissional")}
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4 animate-stagger-fade" style={{ animationDelay: "480ms" }}>
          <div className="rounded-2xl border border-quiz-border/60 bg-quiz-card/90 p-6 flex flex-col items-center text-center space-y-3">
            ...
            <p className="text-sm text-quiz-muted leading-relaxed">
              {t("Se você não ficar satisfeito, devolvemos 100% do seu dinheiro. Sem perguntas, sem burocracia.")}
            </p>
          </div>
        </div>
