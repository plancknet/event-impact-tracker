...
-- Create a function to update quiz responses that bypasses RLS
...
BEGIN
  -- Verify the quiz exists and was created within 30 minutes
  ...
  SET
    ...
    platforms = COALESCE((_data->'platforms')::text[], platforms),
